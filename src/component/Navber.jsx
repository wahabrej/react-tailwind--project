...
const Navbar = () => {
  const [mobileDrawerOpen, setMobiletoggle] = useState(false);
  const toggleNavbar = () => {
    setMobiletoggle(!mobileDrawerOpen);
  }


  return (
    <nav className="sticky top-0 py-3 z-50 backdrop-blur-lg border-b border-neutral-700/80">
      <div className="container  px-4 mx-auto relative  justify-between items-center">
        <div className="flex justify-between items-center">
          <div className="flex items-center flex-shrink-0">
            <img src={logo} className="h-10 w-10 mr-2" alt="" />
            <span className="text-xl tracking-tighter">VirtuallR</span>

          </div>
          <ul className="hidden lg:flex ml-14 space-x-12 justify-center items-center text-xs">
